...
export default function AddTask() {
  ...
  useEffect(() => {
    document.title = 'HeatSafe AI — Add Shift Task';
  }, []);
  ...
  const getForecastStatus = (startTime: string) => {
    ...
    if (diffHours <= 12) {
      return {
        ...
        message: 'Task is within the next 12 hours. Live satellite microclimate forecast telemetry will evaluate this shift and generate active mitigations.',
        buttonText: 'Schedule Task (Live Forecast Active)',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const taskData = {
        ...formData,
        worksiteId: parseInt(worksiteId),
      };

      await tasksApi.create(parseInt(worksiteId), taskData);
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Schedule a task for your worksite</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <form onSubmit={handleSubmit}>
              ...
              <div className="bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-100">Enter task details and schedule</p>
                  </div>
                </div>
              </div>
            ...
            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row mt-3 gap-4 justify-end">
              <button
                type="button"
              ...
              >
                ...
                {forecastStatus?.buttonText || 'Schedule Task'}
              </button>
            </div>
          </form>
        </div>
